...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2024/02/08 20:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">お疲れ様でした</span></span>');
 timer.countDown();
}
